<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="reporteProveedores.aspx.cs" Inherits="CtaCteCompras_Reporte_Proveedores"
    Title="PcSys | Listado de Proveedores " %>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlFiltrarPor" runat="server" Width="160px" AutoPostBack="True">
                    ...
                    <asp:ListItem>Numero de documento</asp:ListItem>
