...
public class NotaCredito
{
    ...
    public string Guardar()
    {
        ...
        try
        {
            ...
            SqlCommand proc = new SqlCommand("sp_abm_notaCredito", _conexion.getSqlConnection());
            ...
            proc.Parameters.Add(new SqlParameter("@id_proveedor", IdProveedor));//1
            ...
            mensaje = proc.Parameters["@mensaje"].Value.ToString();
