...
<div style="display: block;" id="content_2" class="content">
    ...
    <table id="tblOpciones" class="botonera" align="center">
        ...
        <td colspan="4" align="center">
            ...
            <%--<td colspan="4" align="center">
                <!-- Boton buscar, utilizado para actualizar el reporte -->
                <asp:ImageButton ID="btnListar" runat="server" ImageUrl="~/images/list.ico" ToolTip="Listar"
                    OnClientClick="imgbtCancelar" />
                <asp:ImageButton ID="imgbtCancelar" runat="server" ImageUrl="~/images/cancel.png" ToolTip="Salir" 
                    OnClientClick="atrasNotaCredito();return false;" />
            </td>--%>
        </tr>
    </table>
    <hr />
