<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="reporteCtaCteProveedores.aspx.cs" Inherits="CtaCteCompras_reporteCtaCteProveedores"
...
<div style="display: block;" id="content_2" class="content">
    ...
    <!-- Titulo de la pagina -->
        ...
        <div id="divTitulo" class="titulo">
            ...
            Listado de Cta Cte Proveedores </span></strong>
        </div>
        </center>
    <br />
    <br />
        ...
        <table align="center" width="100%">
            <tr>
                <td>
                    ...
                    <CR:CrystalReportViewer ID="crystalReportViewer" runat="server" AutoDataBind="True" DisplayGroupTree="False" BorderStyle="Inset"
                        HasToggleGroupTreeButton="False" GroupTreeStyle-ShowLines="False" HasCrystalLogo="False" Height="50px" Width="350px" />
                        &nbsp;
