...
public partial class CtaCteCompras_Reporte_Nota_Credito : System.Web.UI.Page
{
    /// <summary>
    ...
    {
        this.Response.Redirect("~/CtaCteCompras/NotaCredito.aspx", true);
    }
    ...
    protected void mostrarInforme()
    {
        ...
        try
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("sp_reporte_nota_credito", conexion.getSqlConnection());
   ...
   protected void imgbtnCancelar_Click(object sender, ImageClickEventArgs e)
    {
        Response.Redirect("~/CtaCteCompras/NotaCredito.aspx");
    }
}
