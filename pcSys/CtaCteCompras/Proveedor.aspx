                            ...
                            <center>
                                <table runat="server" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="tbApellido" runat="server" Width="210px" MaxLength="30"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                        ...
                        <center>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="imgbtListar" ToolTip="Listar"  runat="server" OnClientClick="reporte(); return false;" ImageUrl ="~/images/list.ico" />
                                    </td>
